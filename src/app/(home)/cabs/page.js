                      ...
                      <div class="card card-body rounded-0 rounded-bottom p-4">
                        ...
                        <div class="form-check">
                          <input
                            ...
                            id="lauoverType2"
                          />
                          <label class="form-check-label" for="lauoverType2">
                            Indica or similar
                          </label>
                        </div>
                        {/* <!-- Checkbox --> */}
                        <div class="form-check">
                          <input
                            ...
                            id="lauoverType3"
                          />
                          <label class="form-check-label" for="lauoverType3">
                            Dzire or similar
                          </label>
                        </div>
                        {/* <!-- Checkbox --> */}
                        <div class="form-check">
                          <input
                            ...
                            id="lauoverType4"
                          />
                          <label class="form-check-label" for="lauoverType4">
                            Etios or similar
                          </label>
                        </div>
                        {/* <!-- Checkbox --> */}
                        <div class="form-check">
                          <input
                            ...
                            id="lauoverType7"
                          />
                          <label class="form-check-label" for="lauoverType7">
                            Xcent or similar
                          </label>
                        </div>
                        {/* <!-- Checkbox --> */}
                        <div class="form-check">
                          <input
                            ...
                            id="lauoverType8"
                          />
                          <label class="form-check-label" for="lauoverType8">
                            Innova or similar
                          </label>
                        </div>
                        {/* <!-- Checkbox --> */}
                        <div class="form-check">
                          <input
                            ...
                            id="lauoverType9"
                          />
                          <label class="form-check-label" for="lauoverType9">
                ...
                >
                  ...
                  <ul class="list-group list-group-borderless mb-0">
                    ...
                    <li class="list-group-item d-flex text-body mb-0">
                      ...
                      hidden charges - Pay nothing extra than what's mentioned.
                    </li>
                    <li class="list-group-item d-flex text-body mb-0">
                    ...
                    <div class="row g-2 g-sm-4 mb-4">
                      ...
                      <div class="col-md-4 col-xl-3">
                        <div class="bg-light rounded-3 px-4 py-5">
                          <img
                            src="assets/images/category/cab/seadan.svg"
                            alt=""
                          />
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6 col-md-4 col-xl-6">
                        <h4 class="card-title mb-2">
                          <a href="cab-detail.html" class="stretched-link">
                            Camry, Accord
                          </a>
                        </h4>
                        {/* <!-- Nav divider --> */}
                        ...
                        <ul class="list-inline mb-0">
                          <li class="list-inline-item h6 fw-normal me-1 mb-0">
                            4.5
                          </li>
                        ...
                        <ul class="list-group list-group-borderless mb-0">
                          <li class="list-group-item d-flex pb-0 mb-0">
                            <span class="h6 fw-normal mb-0">
                              <i class="bi bi-check-circle me-2"></i>600Kms
                              included. After that $15/Kms
                            </span>
                          </li>
                          <li class="list-group-item d-flex pb-0 mb-0">
                            <span class="h6 fw-normal mb-0">
                          ...
                          <li class="list-group-item d-flex pb-0 mb-0">
                            <span class="h6 fw-normal mb-0">
                              <i class="bi bi-check-circle me-2"></i>Diesel Car
                            </span>
                          </li>
                        </ul>
                      </div>
                  ...
                  <div class="card-body p-0">
                    <div class="row g-2 g-sm-4 mb-4">
                      ...
                      <div class="col-md-4 col-xl-3">
                        <div class="bg-light rounded-3 px-4 py-5">
                          <img
                            src="assets/images/category/cab/lux.svg"
                            alt=""
                          />
                        </div>
                      </div>
                  ...
                  <div class="card-body p-0">
                    <div class="row g-2 g-sm-4 mb-4">
                      ...
                      <div class="col-md-4 col-xl-3">
                        <div class="bg-light rounded-3 px-4 py-5">
                          <img
                            src="assets/images/category/cab/suv.svg"
                            alt=""
                          />
                        </div>
                      </div>
                  ...
                  <div class="card-body p-0">
                    <div class="row g-2 g-sm-4 align-items-center mb-4">
                      ...
                      <div class="col-md-4 col-xl-3">
                        <div class="bg-light rounded-3 px-4 py-5">
                          <img
                            src="assets/images/category/cab/suv-2.svg"
                            alt=""
                          />
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6 col-md-4 col-xl-6">
                        ...
                        {/* <!-- Rating Star --> */}
                        <ul class="list-inline mb-0">
                          <li class="list-inline-item h6 fw-normal mb-0 me-1">
                            4.3
                          </li>
                          <li class="list-inline-item me-0">
                            <i class="fa-solid fa-star text-warning"></i>
